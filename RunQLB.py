...
from Politica import PoliticaSimple, PoliticaSimpleClusterisada, RollOutSimple, RollOutCluster, MonteCarlo, MonteCarloRN, Qlearning, MonteCarlo_Fourier,Qlearning_buffer
...
if __name__ == "__main__":
    ...
    for i in range(instancias_inicio,instancias_final+1):
        ...
        resultados_instancia["FO QL Buffer"] = QL_f.optimo_mejor_betas
        resultados_instancia["T train"] = QL_f.tiempo_entrenamiento
    ...
    # -------------------- Guardar en Excel --------------------
    nombre_archivo = "Resultados_Cluster_QLBuffer.xlsx"
