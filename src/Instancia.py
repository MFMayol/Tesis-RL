...
class Instancia:
    ...
    def __init__(self, ruta_archivo: str, umbral_inventario_clientes, umbral_inventario_vehiculos):
        ...
        self.umbral_inventario_vehiculos = umbral_inventario_vehiculos # valor entre 0 y 1 para definir si tiene posible quiebre
    ...
    def cargar_ids(self):
        '''
        Método que almacena los ids de la instancia para usarlas más adelante
        Parámetros:
            - None
        Retorna:
            - None
